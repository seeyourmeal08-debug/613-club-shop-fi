...
import editorialBottomImg from './assets/editorial_bottom.jpg';
import philosophySpotlightImg from './assets/philosophy_spotlight.jpg';
import heroMainImg from './assets/hero_main.jpg';
    ...
    <div className="min-h-screen bg-neutral-50 selection:bg-neutral-800 selection:text-neutral-50 flex flex-col antialiased">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center bg-neutral-950 overflow-hidden pt-20">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <motion.p 
            ...
            className="text-neutral-300 font-sans text-lg md:text-xl max-w-xl mx-auto leading-relaxed mb-12 px-4"
          >
            613 Club n'est pas qu'une marque c'est une mission. Une partie de chaque vente est reversée à la Yeshiva.
          </motion.p>
          ...
          >
            <a 
              href="#collections" 
              className="bg-[#800020] hover:bg-[#990026] text-white px-10 py-5 rounded-lg font-headline font-bold text-sm tracking-widest uppercase transition-all hover:scale-[1.03] inline-block"
            >
              SHOP ALL
            </a>
          </motion.div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="border-t border-neutral-100 bg-neutral-50 p-6 space-y-4">
                  ...
                  <form onSubmit={handleApplyPromo} className="space-y-2 pb-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        type="text"
                        placeholder="Ex: BONNEFETEPAPA"
                        value={promoInput}
                        onChange={(e) => setPromoInput(e.target.value)}
                        className="flex-1 bg-white border border-neutral-200 rounded px-3 py-2 text-xs font-mono focus:outline-none focus:border-neutral-900 uppercase"
                      />
                      <button
                        type="submit"
                        className="bg-neutral-900 hover:bg-black text-white text-[11px] px-4 py-2 rounded font-mono font-bold tracking-wider uppercase transition-colors"
                      >
                        Appliquer
                      </button>
                    </div>
                    {promoError && (
                      <p className="text-[10px] text-red-600 font-sans font-medium">{promoError}</p>
                    )}
                    {appliedPromo && (
                      <div className="flex items-center justify-between bg-[#800020]/5 border border-[#800020]/20 rounded p-2 text-[11px]">
                        <span className="font-sans text-neutral-800 flex items-center gap-1.5 font-light">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#800020] animate-pulse"></span>
                          Code <span className="text-[#800020] font-extrabold font-mono">{appliedPromo.code}</span> appliqué
                        </span>
                        <div className="flex items-center gap-2">
                          <span className="font-mono font-bold text-[#800020] bg-[#800020]/15 px-1.5 py-0.5 rounded text-[10px]">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              setPromoInput('');
                              triggerToast('Code promo retiré.', 'info');
                            }}
                            className="text-neutral-400 hover:text-neutral-650 text-[10px] underline hover:no-underline font-sans cursor-pointer"
                          >
                            Retirer
                          </button>
                        </div>
                  ...
                  <div className="space-y-1.5 border-t border-neutral-150 pt-3">
                    ...
                    {appliedPromo && (
                      <div className="flex justify-between text-xs text-[#800020] font-sans">
                        <span>Réduction ({appliedPromo.code})</span>
                        <span className="font-mono font-bold">-{discountAmount.toFixed(2)} $ CAD</span>
                      </div>
                    )}
                    ...
                    <span className="text-[9px] text-neutral-400 block font-sans text-right mt-1.5 leading-tight">
                      Le code promo sera également appliqué lors du paiement sécurisé Stripe.
                    </span>
                  </div>
      ...
      <footer className="w-full mt-auto py-16 bg-neutral-100 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div className="flex gap-6 justify-center md:justify-end items-center text-neutral-400">
            <a 
            ...
            >
              <Instagram className="w-4 h-4 text-neutral-500 hover:scale-110 transition-transform" />
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-neutral-600">INSTAGRAM</span>
            </a>
            <button 
